...
import pe.edu.upeu.asistenciaupeujc.repository.InscritoRepositoryImp
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun inscritoRepository(inscRepos: InscritoRepositoryImp): InscritoRepository
